...
# STEP 5
# Replace None with your code
df_executive = pd.read_sql("""SELECT *, CASE
...
# STEP 8
# Replace None with your code
sum_total_price = pd.read_sql("""SELECT ROUND(priceEach * quantityOrdered, 0) AS total_price FROM orderDetails""", conn).sum().reset_index(drop=True)
